...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><h2 style="color:red;font-weight:bold;">Login Here</h2><span class="splash-description"style="color:#05e8c5">Please enter your user information.</span></div>
            <div class="card-body">
